...
- apply Android safe area inset fixes to giver screens
- apply Android safe area inset fixes to recipient screens
- apply Android safe area insets to 10 screens (header, footer, list padding)
- Android glow effects split ios/android Platform.select in HeroPreviewScreen and ChallengeLandingScreen
