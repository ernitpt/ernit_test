...
|--------|------|-------------|
| **Goals** | `goals-system.md` | Core progression, weekly cadence, Valentine's, Free Goals, Motivations. |
...
| **Payments** | `payments-system.md` | Stripe Intents, Webhooks, and Security. |
