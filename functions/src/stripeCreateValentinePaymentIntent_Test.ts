...
// ========== CREATE VALENTINE PAYMENT INTENT (NO AUTH REQUIRED) ==========
export const stripeCreateValentinePaymentIntent_Test = onRequest(
    {
        region: "europe-west1",
    ...
    async (req, res) => {
        ...
        console.log("stripeCreateValentinePaymentIntent_Test origin:", origin);
        ...
        try {
            ...
            console.log("💘 Creating Valentine PaymentIntent:", metadata);
            ...
            const intent = await stripe.paymentIntents.create({
                ...
                metadata, // All Valentine metadata passed through
            });
