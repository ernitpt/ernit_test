...
export const createDeferredGift_Test = onRequest(
    ...
    async (req, res) => {
        ...
        if (idempotencyKey !== undefined) {
            ...
            if (alreadyCompleted) {
                logger.info(`[createDeferredGift_Test] Idempotency key already used: ${idempotencyKey}`);
        ...
        try {
            ...
            logger.info(`✅ [TEST] Created deferred gift ${giftId}, setupIntent ${setupIntentId}`);
