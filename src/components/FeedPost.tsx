                    ...
                    <>
                        ...
                        <View style={styles.progressBlock}>
                            <View style={styles.progressHeader}>
                                ...
                                <Text style={styles.progressText}>
                                    {(post.sessionNumber - post.weeklyCount) / post.totalSessions}/{post.totalSessions / post.sessionsPerWeek}
                                </Text>
                            </View>
                            <View style={styles.capsuleRow}>
                                {Array.from({ length: Math.min(post.totalSessions / post.sessionsPerWeek, 20) }, (_, i) => (
                                    <View
                                        ...
                                        style={[
                                            styles.capsule,
                                            i < ((post.sessionNumber - post.weeklyCount) / post.totalSessions)
                                                ? { backgroundColor: '#84b3e9ff' }
                                                : { backgroundColor: '#E5E7EB' },
                                        ]}
                                    />
